...
class phpweather
{
     ...
     *
     * @param string
     * Temperature to convert, coded to tenth of
     *              degree, like 1015
     * @param   integer
     ...
     *
     * @param  float
     * The value one seeks to convert.
     * @param  string
     * The unit of $value.
     ...
     * @access  public
     */
    function decode_metar($metar, $index = false)
    {
        /* initialization */
